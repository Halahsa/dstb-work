...
bjp_tweets = searchTwitter("South Melbourne", n=2000, lang="en")
...
ggplot(sentiment_dataframe, aes(x=polarity)) +
  ...
  ggtitle('Sentiment Analysis of Tweets on Twitter about Toorak') +
...
comparison.cloud(bjp.tdm, colors = brewer.pal(n_bjp_emos, "Dark2"),
                   scale = c(3,.2), random.order = FALSE, title.size = 1.5)
